                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        ...
                        <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                            <h1>
                                {props.name} <strong className="brand-name">KumarTechnical</strong>
                            </h1>
                            <h2 className="my-3" style={{fontSize:25,color:"grey"}}>
                                We are the team of talented developer making website
                            </h2>
                            <div className="mt-3">
                            <NavLink to={props.visit} type="button" className="btn btn-outline-primary">{props.btnname}</NavLink>
                            </div>
